# Root Dockerfile to build the HRMS backend from hrms_backend/
# Mirrors the original hrms_backend/Dockerfile but adjusts paths
...
USER hrms
ENV PATH=/home/hrms/.local/bin:$PATH
